...
public class MapsAllVente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_all_vente);
    ...
    public Context getContext(){
        return MapsAllVente.this;
    }

    public void Allezsurinternet(Double lat, Double lon) {

        OkHttpClient client = new OkHttpClient();
        String url = "https://sourcedusuccesinternational.com/mapsapi/getallpointvente.php?datassi=ssiapp";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    MapsAllVente.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ...
                            try {
                                ...
                                if ((entries.getString("error")).equals("false")) {
                                    ...
                                    if(donne.length() == 0){
                                        ...
                                        alertDialog = new androidx.appcompat.app.AlertDialog.Builder(MapsAllVente.this).create();
                                        alertDialog.setTitle("Alerte");
                                        alertDialog.setMessage("Aucun point de vente n'est disponible");
                                        ...
                                        data = myResponses;
                                        Toast.makeText(MapsAllVente.this, "Affichage en cours.. ", Toast.LENGTH_SHORT).show();

                                        Fragment fragment = MapsFragment.newInstance(data, lat, lon);
                                        getSupportFragmentManager()
                                                .beginTransaction()
                                                .replace(R.id.frame_vente, fragment)
                                                .commit();
                                    }
                                } else {
